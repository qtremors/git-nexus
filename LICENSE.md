...
- Include a link to the original repository: `https://github.com/qtremors/git-nexus`
...
```
Based on GitNexus by [Tremors](https://github.com/qtremors)
https://github.com/qtremors/git-nexus
```
